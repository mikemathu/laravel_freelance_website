			...
			<div class="panel panel-success">
			  ...
			  <div class="panel-body"><h4>
                  <table style="width:100%">
					...
					// 					<button class='btn btn-danger btn-sm deleteClient btn-flat' data-id='".$row['id']."' onclick='goDoSomething(this);' data-toggle='modal' '><i class='fa fa-trash'></i> Delete</button>  
					// 					</form>
					// 				</td>
                    //                 </tr>
                    //             </form>
