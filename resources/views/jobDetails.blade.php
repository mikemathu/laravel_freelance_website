...
<?php
 ...
 ?>
	...
	<!--artisan Profile Details-->	
		<div class="card" style="padding:20px 20px 5px 20px;margin-top:20px">
			...
			<?php
				...
				// 	echo'
				// 			<a href=" '. $linkBtn .' " id="applybtn" type="button" class="btn btn-warning btn-lg">'.$textBtn.'</a> ';					
				// } 
				...
				// 			//include('includes/jobApplicantsDetails.php');
	...
	<?php 	//include('includes/jobApplicantsDetails.php');  ?>		
	</div>
<!--End Column 1-->
